...
int main(void) {
	...
	defaultTaskHandle = osThreadNew(App_LED_Toggle_Task, NULL, &defaultTask_attributes);
...
static void MX_GPIO_Init(void) {
	...
	GPIO_InitStruct.Pin = A0_Pin | A1_Pin | A2_Pin | A3_Pin | A4_Pin | A5_Pin | SDNRAS_Pin |
	...
	GPIO_InitStruct.Pin = D4_Pin | D5_Pin | D6_Pin | D7_Pin | D8_Pin | D9_Pin | D10_Pin | D11_Pin |
						  D12_Pin | NBL0_Pin | NBL1_Pin;
	GPIO_InitStruct.Mode	  = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull	  = GPIO_NOPULL;
	GPIO_InitStruct.Speed	  = GPIO_SPEED_FREQ_VERY_HIGH;
